                ...
                <div class="container">
                    <div class="carousel-position-four text-center">
                        <h2 class="margin-bottom-20 animate-delay carousel-title-v3 border-bottom-title text-uppercase" data-animation="animated fadeInDown">
                            Wedding with <br/><span class="color-red-v2">HEART</span><br/>
                        </h2>
                        <p class="carousel-subtitle-v2" data-animation="animated fadeInUp" style = "color: #ffffff;">We love to tell your story.</p>
                    </div>
                </div>
            </div>
