				...
				<div class="panel-body">
					<form class="form-horizontal form-bordered" action="#">
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<div class="input-group input-group-icon">
									<input style = "border-radius: 15px;" type="text" class="form-control" placeholder="Nhập tên sản phẩm">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								<div class="input-group input-group-icon">
									<input type="text" class="form-control" placeholder="Chất liệu sản phẩm">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<div class="input-group input-group-icon">
								<textarea style = "width: 220px;" id = "description" name="description">Viết gì đó...</textarea>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" name="state" disabled value="còn hàng">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								<div class="input-group input-group-icon">
									...
									<input type="text" class="form-control" placeholder="SL sản phẩm">
								</div>
							</div>
						</div>
