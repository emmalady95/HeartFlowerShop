<?php 
	...
	$count = mysql_query("SELECT COUNT(*) from account where role = 'VIP'");
	...
	<header class="page-header">
		...
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				...
				<li><span style = "font-size: 12px;">Khách hàng thân thiết</span></li>
			</ol>
				...
				<tbody>
					...
					?>
							<tr style="text-align: center;color: #000;">
								...
								<td>&nbsp;<a href = "?id=<?php echo $m; ?>&manage=account-vip-detail&email=<?php echo $row3['email']; ?>">Chi tiết</a></td>
							</tr>
					<?php
						}
					?>
	...
	<div class = "panel-body">
		<center>
			<div style = "margin-top: 10px;">
				...
				?>
					<a style = "text-decoration: none;margin:10px;color:#000;background:#00cd66;border: dotted #fff0f5; " href = "?id=<?php echo $m;?>&manage=account-vip-list&page=<?php echo $i; ?>">Trang <?php echo $i; ?></a>
				<?php  }
				?>
			</div>
		</center>
